...
// SA12 already fully sorted with results stored in m_d_keys_srt_12
...
// Exclusive scan to compute the position of SA1
  ...
  //        d_keys_sa, ith character value according to m_d_keys_srt_3
  ////////////////////////////////////////////////////////////////////////
...
void allocSkewStorage(CUDPPSkewPlan *plan)
{
    ...
    CUDA_SAFE_CALL(cudaMalloc((void**) &(plan->m_d_new_str), sizeof(bool)));
