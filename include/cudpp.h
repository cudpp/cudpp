 ...
 * of CUDPP
 * - hash_testrig, a comprehensive test application for CUDPP's hash table 
 * data structures
 *
 ...
 * 
 * - Mark Harris, Shubhabrata Sengupta, and John D. Owens. "Parallel Prefix Sum (Scan) with CUDA". In Hubert Nguyen, editor, <i>GPU Gems 3</i>, chapter 39, pages 851&ndash;876. Addison Wesley, August 2007. http://www.idav.ucdavis.edu/publications/print_pub?pub_id=916, http://http.developer.nvidia.com/GPUGems3/gpugems3_ch39.html
 ...
 * David Luebke, Pat McCormick, Kenneth Moreland, and Richard Vuduc for 
 * their contributions during the development of this library. 
 * 
